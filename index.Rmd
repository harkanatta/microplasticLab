...
barCenters <- barplot(as.matrix(Mean),beside = T,ylim = c(0, plotTop),col = litir[1:2],ylab = "MP Particles", xlab = "Station", las=2)
...
barCenters <- barplot(as.matrix(Mean),beside = T,ylim = c(0, plotTop),ylab = expression(paste("MP/m"^"3")), xlab = "Station", las=2, col = litir[1])
segments(barCenters, as.matrix(Mean-SD) * 1, barCenters,
         as.matrix(Mean+SD) * 1, lwd = 1.5)
