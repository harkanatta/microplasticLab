...
```{r pieSize, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Size distribution of the microplastic particles. Blanks are excluded.",dev.args = list(bg = 'transparent')}
...
```{r pieColour, echo=FALSE, fig.cap="Color distribution of the microplastic particles.",dev.args = list(bg = 'transparent')}
